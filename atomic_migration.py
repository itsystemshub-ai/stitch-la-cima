...
# 1. CLEANUP: Delete all .html, .js, .css in frontend and backend
...
# 2. MAPPING: Folder Name -> (Destination Folder, Short Filename)
RENAMES = {
    # Auth
    ...
    "home_la_cima_c.a_": ("ecommerce", "home.html"),
...
for folder_name, (dest_subdir, short_filename) in RENAMES.items():
    ...
    # Handle direct html files in stitch root if any
    if folder_name.endswith('.html'):
