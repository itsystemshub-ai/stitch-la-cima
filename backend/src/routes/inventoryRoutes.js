...
// Stock Operations
router.post('/stock/add', protect, authorize('ADMIN', 'MANAGER'), inventoryController.addStock);
router.post('/stock/remove', protect, authorize('ADMIN', 'MANAGER'), inventoryController.removeStock);
router.post('/stock/adjust', protect, authorize('ADMIN', 'MANAGER'), inventoryController.adjustStock);
