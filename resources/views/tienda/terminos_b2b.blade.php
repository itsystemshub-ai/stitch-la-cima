...
@push('styles')
    <link rel="stylesheet" href="css/terminos_b2b.css">
@endpush
        ...
        <div class="container mx-auto px-6 max-w-4xl">
            ...
            <div class="mt-16 bg-stone-50 border border-outline rounded-xl p-8">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="tel:+584244582766" class="bg-black text-white px-6 py-3 rounded-lg font-bold text-xs uppercase tracking-widest hover:bg-stone-800 transition-all transition-colors">Llamar Ahora</a>
                </div>
            </div>
        </div>
    </section>
...
@push('scripts')
    <script src="js/terminos_b2b.js"></script>
@endpush
