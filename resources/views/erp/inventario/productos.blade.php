    ...
    <div class="bg-white border border-stone-200 rounded-[40px] shadow-sm overflow-hidden mb-12">
        ...
        <div class="overflow-x-auto custom-scrollbar">
            <table class="w-full text-left border-collapse min-w-[1800px]">
                <thead>
                    <tr class="text-[10px] font-black text-stone-400 uppercase tracking-widest border-b border-stone-100 italic bg-stone-50/50">
                        <th class="p-6 text-center">N°</th>
                        <th class="p-6">Foto</th>
                        <th class="p-6">Código OEM</th>
                        <th class="p-6 text-center">Categoría</th>
                        ...
                        <th class="p-6">Descripción (Producto)</th>
                        <th class="p-6 text-center">Medidas</th>
                        <th class="p-6 text-right">Precio Mayor</th>
                ...
                <tbody class="divide-y divide-stone-50 text-xs font-body">
                    ...
                    <tr class="hover:bg-stone-50/80 transition-colors group">
                        ...
                        <td class="p-6 text-center">
                            <span class="px-2 py-1 bg-stone-50 text-stone-500 text-[9px] font-black uppercase rounded border border-stone-100">{{ $product->categoria }}</span>
                        </td>
                        <td class="p-6 text-center uppercase text-stone-500 font-bold">
                            {{ $product->fabricante ?? '-' }}
                        </td>
                        <td class="p-6 text-center uppercase text-stone-900 font-black">
                            {{ $product->marca ?? '-' }}
                        </td>
                        ...
                        <td class="p-6">
                            <div class="min-w-0">
                                ...
                                <p class="text-[9px] text-stone-400 font-bold uppercase tracking-widest italic leading-none">{{ $product->codigo_interno }}</p>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="13" class="p-20 text-center">
                            <p class="text-[10px] font-black text-stone-400 uppercase tracking-widest italic">No se encontraron productos en el Maestro</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
