...
@section('title', 'LA CIMA - ADMIN FORGE v2.4 | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/flujos-aprobacion.css">
@endpush
...
@push('scripts')
    <script src="/frontend/public/erp/js/flujos-aprobacion.js"></script>
@endpush
