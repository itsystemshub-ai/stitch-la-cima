...
<meta name="description" content="Reporte Anual de Ventas | TITAN ERP - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>Reporte Anual de Ventas | TITAN ERP | ERP La Cima</title>
...
<link rel="stylesheet" href="css/rendimiento-anual.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<span class="font-bold">Analíticas</span>
...
<script src="js/rendimiento-anual.js"></script>
</body>
</html>