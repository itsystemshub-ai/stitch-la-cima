...
<meta name="description" content="LA CIMA - ADMIN FORGE v2.4 | USER ACCESS - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>LA CIMA - ADMIN FORGE v2.4 | USER ACCESS | ERP La Cima</title>
...
<link rel="stylesheet" href="css/usuarios-roles.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/usuarios-roles.js"></script>
</body>
</html>