...
<meta name="description" content="Portal del Empleado - TITAN INDUSTRIAL ERP - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>Portal del Empleado - TITAN INDUSTRIAL ERP | ERP La Cima</title>
...
<link rel="stylesheet" href="css/portal-empleado.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/portal-empleado.js"></script>
</body>
</html>