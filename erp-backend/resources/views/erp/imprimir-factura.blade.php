...
<meta name="description" content="Vista Previa de Impresión - TITAN INDUSTRIAL - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>Vista Previa de Impresión - TITAN INDUSTRIAL | ERP La Cima</title>
...
<link rel="stylesheet" href="css/imprimir-factura.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/imprimir-factura.js"></script>
</body>
</html>