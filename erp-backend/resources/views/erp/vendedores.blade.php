...
@section('title', 'TITAN ERP | Gestión de Vendedores | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/vendedores.css">
@endpush
...
@push('scripts')
    <script src="/frontend/public/erp/js/vendedores.js"></script>
@endpush
