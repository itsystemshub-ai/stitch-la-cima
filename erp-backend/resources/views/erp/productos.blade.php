...
@section('content')
<!-- Barra Lateral y Header se manejan similar a inicio.blade.php o se pueden incrustar si son especificos -->
<!-- En este caso, productos.html tiene un sidebar que parece estandar para Zenith 3.0 -->

<!-- ========== CONTENIDO PRINCIPAL ========== -->
<main class="ml-[288px] w-[calc(100vw-288px)] mt-[65px] p-10 flex-col flex-1 bg-[#0c0e10] min-h-screen">
    <!-- Page Title -->
        ...
        <div class="overflow-x-auto custom-scrollbar">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-outline">
                    <!-- Fila estatica de ejemplo (luego sera dinamica) -->
    ...
    <!-- Summary Statistics -->
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mt-12 mb-10">
        <div class="md:col-span-8 bg-black border-l-8 border-primary p-10 relative overflow-hidden">
        ...
        <div class="md:col-span-4 bg-surface border-l-8 border-[#FFB300] p-10 flex flex-col justify-between">
            <div>
            ...
            <button class="w-full py-5 mt-6 bg-black border border-[#FFB300]/20 text-[10px] font-black uppercase text-[#FFB300] tracking-[0.2em] hover:bg-[#FFB300] hover:text-black transition-all">
