...
<meta name="description" content="auditoria-seguridad - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>auditoria-seguridad | ERP La Cima</title>
...
<link rel="stylesheet" href="css/auditoria-seguridad.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/auditoria-seguridad.js"></script>
</body>
</html>