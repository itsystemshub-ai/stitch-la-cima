...
<meta name="description" content="Sales Reporting Center | INDUSTRIAL FORGE ERP - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>Sales Reporting Center | INDUSTRIAL FORGE ERP | ERP La Cima</title>
...
<link rel="stylesheet" href="css/reportes-ventas.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
