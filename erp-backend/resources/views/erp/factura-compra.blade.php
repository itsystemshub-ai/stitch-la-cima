...
@section('title', 'factura-compra | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/factura-compra.css">
@endpush
...
@push('scripts')
    <script src="/frontend/public/erp/js/factura-compra.js"></script>
@endpush
