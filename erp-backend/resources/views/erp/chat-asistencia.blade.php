...
<meta name="description" content="chat-asistencia - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>chat-asistencia | ERP La Cima</title>
...
<link rel="stylesheet" href="css/chat-asistencia.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/chat-asistencia.js"></script>
</body>
</html>