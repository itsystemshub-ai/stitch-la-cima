...
@section('title', 'RRHH | ERP La Cima | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/rrhh.css">
@endpush
          ...
          <table class="w-full">
            <thead class="border-b border-stone-200">
              <tr>
                ...
                <th
                  class="text-xs font-bold text-stone-500 uppercase tracking-wider pb-3 text-center"
                >
                  Estado
                </th>
              </tr>
            ...
            <tbody class="divide-y divide-stone-100">
              <tr class="hover:bg-stone-50 transition-colors">
                <td class="py-3">
                  <div class="flex items-center gap-3">
                    <div
                      class="w-8 h-8 bg-stone-200 rounded-full flex items-center justify-center text-xs font-bold"
                    >
                      JP
                    </div>
                    <div>
...
@push('scripts')
    <script src="/frontend/public/erp/js/rrhh.js"></script>
@endpush
