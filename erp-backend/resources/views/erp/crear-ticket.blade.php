...
<meta name="description" content="New Support Ticket | INDUSTRIAL FORGE ERP - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>New Support Ticket | INDUSTRIAL FORGE ERP | ERP La Cima</title>
...
<script src="js/crear-ticket.js"></script>
</body>
</html>