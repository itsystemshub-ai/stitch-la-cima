...
@section('title', 'Order Confirmation | MAYOR DE REPUESTO LA CIMA, C.A. | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/orden-confirmada.css">
@endpush
...
@push('scripts')
    <script src="/frontend/public/erp/js/orden-confirmada.js"></script>
@endpush
