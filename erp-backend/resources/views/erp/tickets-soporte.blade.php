...
<meta name="description" content="tickets-soporte - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>tickets-soporte | ERP La Cima</title>
...
<link rel="stylesheet" href="css/tickets-soporte.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/tickets-soporte.js"></script>
</body>
</html>