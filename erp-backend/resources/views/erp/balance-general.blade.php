...
@section('title', 'Balance General - MAYOR DE REPUESTO LA CIMA, C.A. | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/balance-general.css">
@endpush
...
<p class="text-primary-container font-medium uppercase tracking-[0.3em] text-sm">Estado de Situaci贸n Financiera</p>
...
<tr class="hover:bg-white/5 transition-colors group">
<td class="py-3 text-zinc-400 group-hover:text-white">IVA Cr茅dito Fiscal</td>
...
<tr class="hover:bg-white/5 transition-colors group">
<td class="py-3 text-zinc-400 group-hover:text-white">Depreciaci贸n Acumulada</td>
...
<tbody class="divide-y divide-white/5">
<tr class="hover:bg-white/5 transition-colors group">
<td class="py-3 text-zinc-400 group-hover:text-white">Pr茅stamos Bancarios Largo Plazo</td>
...
<span class="text-xs uppercase">Direcci贸n de Finanzas</span>
</div>
</div>
<div class="text-[9px] text-right max-w-sm uppercase leading-relaxed font-mono">
                Este documento es una representaci贸n t茅cnica de la salud financiera de MAYOR DE REPUESTO LA CIMA, C.A. La integridad de los datos de inventario est谩 vinculada directamente al sistema ERP FINANCE_ENGINE Core.
            </div>
</footer>
</main>
@endsection
...
@push('scripts')
    <script src="/frontend/public/erp/js/balance-general.js"></script>
@endpush
