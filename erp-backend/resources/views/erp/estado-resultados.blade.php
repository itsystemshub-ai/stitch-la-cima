...
<meta name="description" content="FINANCE_ENGINE - MAYOR DE REPUESTO LA CIMA, C.A. - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>FINANCE_ENGINE - MAYOR DE REPUESTO LA CIMA, C.A. | ERP La Cima</title>
...
<link rel="stylesheet" href="css/estado-resultados.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<!-- ========== CONTENIDO PRINCIPAL ========== -->
<main class="ml-64 pt-16 h-screen overflow-y-auto custom-scrollbar bg-zinc-950">
...
<h1 class="text-5xl font-black text-zinc-50 uppercase tracking-tighter leading-none">MAYOR DE REPUESTO<br/>LA CIMA, C.A.</h1>
<p class="text-zinc-500 font-['Space_Grotesk'] text-sm tracking-widest mt-4">PERÍODO FISCAL 2023 | ESTRUCTURA NIIF (IFRS)</p>
</div>
<div class="flex gap-3">
<button class="flex items-center gap-2 bg-zinc-900 px-6 py-3 text-zinc-300 font-['Inter'] font-bold text-xs uppercase tracking-widest hover:bg-zinc-800 transition-all border border-zinc-800">
<span class="material-symbols-outlined text-sm">download</span>
<span>EXPORT PDF</span>
</button>
<button class="flex items-center gap-2 bg-amber-500 px-6 py-3 text-zinc-950 font-['Inter'] font-bold text-xs uppercase tracking-widest hover:brightness-110 transition-all">
...
<div class="col-span-12 md:col-span-4 bg-zinc-900/50 p-8 relative overflow-hidden group">
...
<div class="mt-6 w-full bg-zinc-800 h-1">
<div class="bg-amber-500 h-1 w-[68%]"></div>
</div>
</div>
<!-- Operating Margin -->
<div class="col-span-12 md:col-span-4 bg-zinc-900/50 p-8">
...
<div class="col-span-12 md:col-span-4 bg-amber-500 p-8">
...
<div class="bg-zinc-900/30 overflow-hidden">
...
<td class="py-4 px-8 text-right text-xs font-bold text-error">($ 323.812,78)</td>
<td class="py-4 px-8 text-right text-[10px] font-bold text-zinc-600">--</td>
</tr>
<!-- FINAL NET -->
...
<div class="p-8 border border-zinc-800/50 bg-zinc-900/20">
...
<p class="text-xs text-zinc-500 leading-relaxed font-['Inter']">
