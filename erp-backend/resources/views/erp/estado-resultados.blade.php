...
@section('title', 'FINANCE_ENGINE - MAYOR DE REPUESTO LA CIMA, C.A. | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/estado-resultados.css">
@endpush
...
@push('scripts')
    <script src="/frontend/public/erp/js/estado-resultados.js"></script>
@endpush
