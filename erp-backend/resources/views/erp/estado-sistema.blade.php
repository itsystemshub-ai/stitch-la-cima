...
@section('title', 'INDUSTRIAL FORGE ERP - System Status | ERP La Cima')

@push('styles')
    <link rel="stylesheet" href="/frontend/public/erp/css/estado-sistema.css">
@endpush
...
@push('scripts')
    <script src="/frontend/public/erp/js/estado-sistema.js"></script>
@endpush
