...
<meta name="description" content="Legal Configuration &amp; SENIAT Compliance | TRUCKPRO ERP - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>Legal Configuration &amp; SENIAT Compliance | TRUCKPRO ERP | ERP La Cima</title>
...
<link rel="stylesheet" href="css/config-fiscal.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/config-fiscal.js"></script>
</body>
</html>