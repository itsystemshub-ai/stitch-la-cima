...
<meta name="description" content="factura-fiscal - MAYOR DE REPUESTO LA CIMA, C.A."/>
<meta name="theme-color" content="#ceff5e">
<link rel="manifest" href="../manifest.json">
<link rel="icon" type="image/png" href="{{ asset('assets/images/logo.png') }}">
<title>factura-fiscal | ERP La Cima</title>
...
<link rel="stylesheet" href="css/factura-fiscal.css">
<script>
  tailwind.config = {
    darkMode: "class",
    theme: {
...
<script src="js/factura-fiscal.js"></script>
</body>
</html>