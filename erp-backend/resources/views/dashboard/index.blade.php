...
@section('content')
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
    ...
    <!-- Inventario -->
    <a href="#" class="bg-white border border-stone-200 rounded-xl p-5 hover:shadow-lg hover:border-primary/50 transition-all group">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="lg:col-span-2 bg-white border border-stone-200 rounded-xl p-6">
      <div class="flex justify-between items-center mb-6">
        ...
        <a href="#" class="text-xs font-bold text-stone-500 hover:text-stone-900 flex items-center gap-1">
          Ver completo
    ...
    <div class="bg-stone-900 text-white rounded-xl p-6 relative overflow-hidden">
      ...
      <div class="relative">
        ...
        <div class="flex gap-2">
          <a href="#" class="flex-1 bg-primary text-stone-900 py-2.5 font-bold text-sm rounded-lg hover:brightness-110 transition-all text-center">
            VER VENTAS
          </a>
          <a href="{{ url('/pos') }}" class="w-10 h-10 border border-stone-700 flex items-center justify-center hover:bg-stone-800 rounded-lg transition-colors">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white border border-stone-200 rounded-xl p-6">
      ...
      <div class="mt-5 pt-4 border-t border-stone-100 flex gap-2">
        <a href="#" class="flex-1 border border-stone-300 text-stone-700 py-2 text-xs font-bold rounded-lg hover:bg-stone-50 transition-all text-center">
          DETALLES
        </a>
        <a href="#" class="flex-1 bg-stone-900 text-white py-2 text-xs font-bold rounded-lg hover:bg-stone-800 transition-all text-center">
          BACKUP AHORA
        </a>
      </div>
    </div>
  ...
  <div class="bg-white border border-stone-200 rounded-xl p-6 mb-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
      <!-- Inventario -->
      <a href="#" class="bg-blue-50 border border-blue-100 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-blue-300 group">
      ...
      <!-- Ventas -->
      <a href="#" class="bg-green-50 border border-green-100 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-green-300 group">
      ...
      <!-- Compras -->
      <a href="#" class="bg-purple-50 border border-purple-100 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-purple-300 group">
      ...
      <!-- Contabilidad -->
      <a href="#" class="bg-orange-50 border border-orange-100 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-orange-300 group">
      ...
      <!-- Finanzas -->
      <a href="#" class="bg-yellow-50 border border-yellow-100 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-yellow-300 group">
      ...
      <!-- RRHH -->
      <a href="#" class="bg-pink-50 border border-pink-100 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-pink-300 group">
      ...
      <!-- Configuracion -->
      <a href="{{ url('/erp/sync') }}" class="bg-stone-50 border border-stone-200 rounded-xl p-4 text-center hover:shadow-md transition-all hover:border-stone-300 group">
  ...
  <div class="pt-4 border-t border-stone-100 flex flex-col md:flex-row justify-between items-center gap-4">
    ...
    <div class="flex items-center gap-4">
      <a href="#" class="text-[10px] font-bold text-stone-500 hover:text-stone-900">Centro de Ayuda</a>
      <a href="#" class="text-[10px] font-bold text-stone-500 hover:text-stone-900">Manual Técnico</a>
      <a href="#" class="text-[10px] font-bold text-stone-500 hover:text-stone-900">Estado del Sistema</a>
    </div>
  </div>
@endsection
