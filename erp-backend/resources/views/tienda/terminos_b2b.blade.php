...
<head>
    ...
    <meta name="description" content="Términos B2B - MAYOR DE REPUESTO LA CIMA, C.A. Condiciones comerciales para empresas."/>
    ...
    <title>Términos B2B | Mayor de Repuesto LA CIMA, C.A.</title>
...
<script>
  tailwind.config = {
    ...
    <script src="{{ asset('ecommerce/js/terminos_b2b.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('ecommerce/css/terminos_b2b.css') }}">
</head>
