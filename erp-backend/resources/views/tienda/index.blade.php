...
@push('styles')
    <link rel="stylesheet" href="/frontend/public/ecommerce/css/index.css">
@endpush
...
<a href="/auth/login" class="bg-white text-black px-6 py-2 rounded-md font-black text-[10px] uppercase tracking-[0.2em] hover:bg-primary transition-all">
...
<a href="/auth/login" class="bg-primary text-black px-10 py-5 font-black uppercase tracking-[0.2em] rounded-sm hover:scale-105 transition-transform inline-block text-center">
                            Entrar al ERP
                        </a>
<a href="/auth/crear_cuenta" class="border border-white/20 text-white px-10 py-5 font-black uppercase tracking-[0.2em] rounded-sm hover:bg-white hover:text-black transition-all inline-block text-center">
                            Solicitar Registro
                        </a>
</div>
</div>
...
@push('scripts')
    <script src="/frontend/public/ecommerce/js/index.js"></script>
