...
<html class="light" lang="es">
  <head>
    ...
    <meta
      name="description"
      content="Sobre nosotros - MAYOR DE REPUESTO LA CIMA, C.A. Líder en repuestos industriales."
    />
    ...
    <title>Nosotros | Mayor de Repuesto LA CIMA, C.A.</title>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <script src="{{ asset('ecommerce/js/nosotros.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('ecommerce/css/nosotros.css') }}" />
  </head>
  <body class="bg-background text-on-surface selection:bg-primary/30">
    ...
    <!-- Hero Section -->
    <section
      class="relative min-h-[90vh] flex items-center overflow-hidden bg-black pt-16"
    >
      ...
      <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-4xl">
          <div
            class="inline-block px-3 py-1 bg-primary text-black font-bold text-xs tracking-widest uppercase mb-6"
          >
            Industrial Grade Precision
          </div>
          <h1
            class="text-white font-headline text-6xl md:text-8xl font-black tracking-tighter uppercase leading-[0.9] mb-8"
          >
            POWERING THE <br />
            <span class="text-primary">HEAVY INDUSTRY</span>
          </h1>
          <p
            class="text-stone-300 text-lg md:text-xl max-w-xl mb-10 leading-relaxed"
          >
          ...
          <div class="flex flex-wrap gap-4">
            <a
              ...
              class="bg-primary hover:bg-white text-black px-8 py-4 font-bold uppercase tracking-widest transition-all inline-block text-center"
              >Explorar Catálogo</a
            >
            <a
              href="{{ url('/tienda/soporte') }}"
              class="border border-white text-white px-8 py-4 font-bold uppercase tracking-widest hover:bg-white/10 transition-all inline-block text-center"
              >Soporte Técnico</a
            >
          </div>
        </div>
    ...
    <section class="py-24 bg-white" id="nosotros">
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2
              class="font-headline text-4xl md:text-5xl font-black uppercase tracking-tight text-black mb-8"
            >
            ...
            <div class="grid grid-cols-2 gap-8 mt-12">
              <div class="border-l-4 border-primary pl-4">
                ...
                <div
                  class="text-xs uppercase tracking-widest text-[#5a5c5e] font-black"
                >
                  Calidad Certificada
                </div>
              </div>
    ...
    <section class="py-24 bg-white" id="productos">
      <div class="container mx-auto px-6">
        <div
        ...
        >
          <div>
            <span
              ...
              >Inventario Premium</span
            >
            <h2
              class="font-headline text-4xl md:text-5xl font-black uppercase tracking-tight"
            >
              Productos Destacados
            </h2>
          </div>
          <a
            class="group flex items-center gap-2 font-bold uppercase text-sm tracking-tighter"
            href="{{ url('/tienda/catalogo_general') }}"
          >
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div
            class="md:col-span-2 md:row-span-2 bg-stone-100 p-8 group overflow-hidden relative"
          >
            <div class="relative z-10">
              <h3 class="font-headline text-3xl font-bold uppercase mb-4">
                Motores de Combustión
              </h3>
              <p class="text-on-surface-variant max-w-xs mb-8">
                Kits completos de reconstrucción para Caterpillar y Cummins.
              </p>
              <span
                class="inline-block bg-black text-white px-6 py-2 font-bold text-xs uppercase tracking-widest"
                >Desde $2,499.00</span
              >
            </div>
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBs7FyS59QSZ7AQaRhgCOU5nJ6sCV_pfbB3wFjJVeDXfkctEE82M6IltB0ktJ2brwRg8nvJcz9nOKXyr76xMha99OSJslZC2xgIuYj17c86PL7LCRNxZp6EAadxPw1Xel3QcJ7ibfB-OV4SfPGPaSrR9u4ZZF_R1GCcGGQZcAqoEJLIMsIwdg-eeWcc_b5GeybObx_TPJHFr_8eVPL74EMmxMeauierE8dZ9GGAn99Osq5X81hIvQ6mSRhoGIbYaeabYeU8hLGRey0"
              class="absolute bottom-0 right-0 w-2/3 h-auto object-contain translate-y-12 group-hover:translate-y-4 transition-transform duration-500 opacity-80"
            />
          </div>
          <div
            class="md:col-span-2 bg-stone-100 p-8 flex justify-between items-center group"
          >
            <div>
              <h3 class="font-headline text-xl font-bold uppercase mb-2">
                Transmisiones
              </h3>
              <p class="text-xs text-[#5a5c5e] font-bold mb-4">
                Engranajes de alto torque
              </p>
              <button
                class="text-black font-bold text-sm uppercase tracking-widest flex items-center gap-1 hover:text-primary transition-colors"
              >
                Detalles
            ...
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDhthO7FlH1GNTkES8BhO9IXdq8rmj__2MFjMf_YQEeQKDv6wAovt0p9jjvOwkcwH1Filj-dgftC4FP6OJ4A78NRMRSBlfdXHnpuzGNAJtsHpOnRmML7ssz2IzVvTulxUG6ISXCJOEeF_y3wP2tmDUOIdHR2kSSsjTVoO_RWutmLyHyukXgFHwq43-DMXN5yW-UdGCvkkTKQjiVpDesVwL2EfnqZkYafDlWyR3d1_Wx6CftEvUB4ZKf_HAJwmzeQ7ABqxEsvNwjTs0"
              class="w-32 h-32 object-cover grayscale group-hover:grayscale-0 transition-all"
            />
          </div>
          <div
            class="md:col-span-1 bg-stone-100 p-6 flex flex-col justify-between h-full"
          >
            <div>
              <h3 class="font-headline text-lg font-bold uppercase mb-2">
                Electricidad
              </h3>
              <p
                class="text-xs text-[#5a5c5e] font-bold uppercase tracking-widest"
              >
                Alternadores reforzados
              </p>
            </div>
            <div class="mt-8">
          ...
          <div
            class="md:col-span-1 bg-black p-6 flex flex-col justify-between h-full text-white"
          >
            <div>
              <h3 class="font-headline text-lg font-bold uppercase mb-2">
                Suspensión
              ...
              <p
                class="text-xs text-stone-500 font-bold uppercase tracking-widest"
              >
                Soportes HD
              </p>
            </div>
    ...
    <section class="py-24 bg-white">
      <div class="container mx-auto px-6">
        <h2
          class="font-headline text-2xl font-bold uppercase tracking-widest mb-12 flex items-center gap-4 text-black"
        >
          <span class="w-12 h-[2px] bg-primary text-black font-bold"></span>
          Compatibilidad Técnica
        </h2>
        <div class="overflow-x-auto">
          <table class="w-full text-left">
            <thead
              class="uppercase text-xs tracking-[0.2em] font-black text-on-surface-variant border-b border-outline"
            >
              <tr>
                <th class="pb-4 px-4">Componente</th>
                <th class="pb-4 px-4">Marca compatible</th>
                <th class="pb-4 px-4">Origen</th>
                <th class="pb-4 px-4">Certificación</th>
                <th class="pb-4 px-4">Stock</th>
              </tr>
            </thead>
            <tbody class="text-sm">
              <tr
                class="bg-white hover:bg-stone-50 transition-colors border-b border-outline"
              >
                <td class="py-4 px-4 font-bold">Inyectores de Combustible</td>
                <td class="py-4 px-4">CAT / Perkins</td>
                <td class="py-4 px-4 text-stone-500">USA / Germany</td>
              ...
              <tr
                class="bg-stone-50 hover:bg-stone-100 transition-colors border-b border-outline"
              >
                <td class="py-4 px-4 font-bold">Kits de Empacadura</td>
                <td class="py-4 px-4">Detroit Diesel</td>
                <td class="py-4 px-4 text-stone-500">USA</td>
                <td class="py-4 px-4 font-medium uppercase text-[10px]">
                  SAE Standard
                </td>
                <td class="py-4 px-4 text-primary font-bold">In Stock</td>
              </tr>
              <tr class="bg-white hover:bg-stone-50 transition-colors">
                ...
                <td class="py-4 px-4 text-stone-500">Brazil</td>
                <td class="py-4 px-4 font-medium uppercase text-[10px]">
                  Heavy Duty Grade
                </td>
    ...
    <section class="py-24 bg-white" id="contacto">
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              class="font-headline text-5xl font-black uppercase tracking-tighter mb-8 leading-none"
            >
              Estamos en el <br /><span
                class="text-primary-dim px-2 bg-black text-white"
                >Corazón Industrial</span
              >
            </h2>
            ...
            <div class="space-y-8">
              <div class="flex gap-4">
                <span
                  class="material-symbols-outlined text-black bg-primary p-2 rounded"
                  >location_on</span
                >
                <div>
                  <h4
                    class="font-bold uppercase text-[10px] tracking-widest text-[#5a5c5e] mb-1"
                  >
                    Dirección
                  </h4>
          ...
          <div
            class="h-[500px] bg-stone-100 relative overflow-hidden group shadow-2xl"
          >
            <img
            ...
            />
            <div
              class="absolute bottom-6 left-6 bg-black p-6 text-white max-w-sm"
            >
              <h3 class="font-bold uppercase text-primary mb-2">Visítanos</h3>
              <p
                class="text-xs uppercase font-bold tracking-widest text-stone-500"
              >
