...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('auth/css/olvido_contrasena.css') }}">
</head>
...
<div class="md:col-span-5 bg-stone-900 p-8 flex flex-col justify-between relative overflow-hidden rounded-l-lg">
<div class="absolute inset-0 opacity-20 pointer-events-none">
<img alt="Industrial machinery texture" class="w-full h-full object-cover grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDTkZtJSSNsIHQErzV1_9XzToxX14snaVh43pqwzxNW6Ysrohl30gc_ET3s2rbj_7xZPTRmQl6vkH5UscwLPkzzpOtsC8WKPHdFedPQRqjs9ltLOdAbPSm9OUkB0jAHwI5AVbjXmmuFCrQBtiUrmD9q5KNpxxK6zXS6ormvjXgxV_NL5LbNwo1zdKtlB8zFOOCA6tzK7QaADLxWIOQccfeV4ZjoVm0mtOIqsFO9_lx9JC9SkXIBSc515ARVcq2IuNoRbZXElNdOh48"/>
</div>
...
<input id="recoveryEmail" name="recoveryEmail" class="w-full pl-12 pr-4 py-4 bg-stone-50 border border-stone-100/50 text-stone-900 placeholder:text-stone-400 font-body text-sm focus:ring-2 focus:ring-primary focus:bg-white transition-all outline-none rounded-xl" placeholder="operador@lacima.repuestos.com" type="email" required/>
</div>
</div>
...
<!-- Submit Button -->
<button class="w-full bg-stone-900 py-5 px-6 text-white font-headline font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 hover:bg-black hover:shadow-xl transition-all group rounded-xl" type="submit">
...
<a class="text-[10px] font-bold text-stone-400 uppercase hover:text-stone-900 tracking-widest flex items-center gap-1 transition-colors" href="{{ url('/auth/login') }}">
...
<script src="{{ asset('auth/js/olvido_contrasena.js') }}"></script>
