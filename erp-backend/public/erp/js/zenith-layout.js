...
const ZENITH_LAYOUT = {
        ...
        const sidebarHTML = `
            <aside id="sidebar" class="h-screen w-72 fixed left-0 top-0 z-50 flex flex-col bg-white border-r border-stone-200 sidebar">
                ...
                <nav class="flex-1 px-3 space-y-0.5 pb-24 overflow-y-auto no-scrollbar">
                    <a href="/erp/inicio" class="menu-item flex items-center gap-3 px-4 py-2 transition-colors nav-link" data-page="inicio">
                    ...
                    <div class="menu-parent pt-2">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/registro-ventas"><span class="material-symbols-outlined">list_alt</span> Diario de Ventas</a>
                            <a href="/erp/factura-electronica"><span class="material-symbols-outlined">receipt</span> Fact. Electrónica</a>
                            <a href="/erp/facturas-emitidas"><span class="material-symbols-outlined">history</span> Historial Facturas</a>
                            <a href="/erp/clientes"><span class="material-symbols-outlined">person</span> Clientes B2B</a>
                            <a href="/erp/vendedores"><span class="material-symbols-outlined">badge</span> Fuerza de Ventas</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/productos"><span class="material-symbols-outlined">category</span> Catálogo Items</a>
                            <a href="/erp/kardex"><span class="material-symbols-outlined">list</span> Kardex Movimientos</a>
                            <a href="/erp/ajustes-inventario"><span class="material-symbols-outlined">edit_note</span> Ajustes Stock</a>
                            <a href="/erp/auditoria-inventario"><span class="material-symbols-outlined">fact_check</span> Auditoría Física</a>
                            <a href="/erp/reportes-inventario"><span class="material-symbols-outlined">assessment</span> Reportes Logística</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/proveedores"><span class="material-symbols-outlined">local_shipping</span> Proveedores</a>
                            <a href="/erp/factura-compra"><span class="material-symbols-outlined">receipt_long</span> Facturas Compra</a>
                            <a href="/erp/historial-compras"><span class="material-symbols-outlined">history_edu</span> Historial</a>
                            <a href="/erp/reportes-compras"><span class="material-symbols-outlined">analytics</span> Análisis Compras</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent pt-2 border-t border-stone-100">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/plan-cuentas"><span class="material-symbols-outlined">account_tree</span> Plan de Cuentas</a>
                            <a href="/erp/balance-general"><span class="material-symbols-outlined">balance</span> Balance General</a>
                            <a href="/erp/estado-resultados"><span class="material-symbols-outlined">monitoring</span> Resultados</a>
                            <a href="/erp/libro-diario"><span class="material-symbols-outlined">menu_book</span> Libro Diario</a>
                            <a href="/erp/cierre-contable"><span class="material-symbols-outlined">lock</span> Cierre Periodo</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent">
                        ...
                        <div class="submenu">
                            <a href="/erp/libros-legales"><span class="material-symbols-outlined">library_books</span> Libros Legales</a>
                            <a href="/erp/libro-ventas"><span class="material-symbols-outlined">list</span> Libro de Ventas</a>
                            <a href="/erp/libro-compras"><span class="material-symbols-outlined">list</span> Libro de Compras</a>
                            <a href="/erp/declaracion-iva.html"><span class="material-symbols-outlined">account_balance_wallet</span> IVA / Fiscal</a>
                            <a href="/erp/config-fiscal"><span class="material-symbols-outlined">settings_applications</span> Config Fiscal</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent pt-2 border-t border-stone-100">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/empleados"><span class="material-symbols-outlined">person_add</span> Ficha Empleado</a>
                            <a href="/erp/nomina"><span class="material-symbols-outlined">payments</span> Cálculo Nómina</a>
                            <a href="/erp/prestaciones"><span class="material-symbols-outlined">savings</span> Prestaciones</a>
                            <a href="/erp/portal-empleado"><span class="material-symbols-outlined">account_box</span> Portal</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent pt-2 border-t border-stone-100">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/usuarios-roles"><span class="material-symbols-outlined">admin_panel_settings</span> Roles & Accesos</a>
                            <a href="/erp/base-datos"><span class="material-symbols-outlined">database</span> Base de Datos</a>
                            <a href="/erp/backups"><span class="material-symbols-outlined">backup</span> Resguardos/Backups</a>
                            <a href="/erp/auditoria-seguridad"><span class="material-symbols-outlined">assignment_ind</span> Log Accesos</a>
                            <a href="/erp/estado-sistema"><span class="material-symbols-outlined">cloud_circle</span> Monitor Servidor</a>
                        </div>
                    </div>
                    ...
                    <div class="menu-parent mb-8">
                        ...
                        <div class="submenu">
                            ...
                            <a href="/erp/base-conocimiento"><span class="material-symbols-outlined">library_books</span> Knowledge</a>
                            <a href="/erp/tickets-soporte"><span class="material-symbols-outlined">support</span> Tickets</a>
                            <a href="/erp/chat-asistencia"><span class="material-symbols-outlined">chat</span> Chat Directo</a>
                        </div>
                    </div>
                </nav>
                ...
                <div class="flex justify-between items-center px-6 py-3">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="hidden md:flex items-center gap-2 text-[10px] font-black text-stone-400 uppercase tracking-[0.1em]">
                            <a href="/erp/inicio" class="hover:text-stone-900 transition-colors">ZENITH CORE</a>
    ...
    highlightActive: function() {
        ...
        links.forEach(link => {
            ...
            if (href && (window.location.pathname === href || window.location.pathname === href + '.html')) {
